...
class DetailsForm extends Component {
                ...
                <CardBody>
                  <Formik
                    initialValues={{
                      ...
                      township: this.state.values.township,
                      classCode: this.state.values.classCode,
                      assessedValue: this.state.values.assessedValue,
                      marketValue: this.state.values.marketValue,
                      taxesPerYear: this.state.values.taxesPerYear,
                      preeqexm: this.state.values.preeqexm,
                      homeOwner: this.state.values.homeOwner,
                      seniorExemption: this.state.values.seniorExemption,
                      seniorFreeze: this.state.values.seniorFreeze,
                      totalAcres: this.state.values.totalAcres,
                      legalDescription: this.state.values.legalDescription,
                      googleMapView: ""
                    }}
            ...
            <Row>
              <Colxx sm="12">
                <CardBody>
                  <Formik
                    initialValues={{
                      creditor: this.state.values.creditor,
                      amount: this.state.values.amount,
                      paymentAmount: this.state.values.paymentAmount
                    }}
                ...
                <CardBody>
                  <Formik
                    initialValues={{
                      ...
                      address: this.state.values.street,
                      city: this.state.values.city,
                      state: this.state.values.state,
                      zip: this.state.values.zip
                    }}
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      values: this.props.location.state.select
    };
  }
